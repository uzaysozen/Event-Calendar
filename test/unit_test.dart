...
void main() {
  group("getTimeText", () {
    ...
    test('Time text test with 1 second duration', () {
      Duration d = Duration(minutes: 1, seconds: 1);
      expect(getTimeText(d), "1 minute 1 second");
    });

    test('Time text test with 1 second duration', () {
      Duration d = Duration(hours:1, minutes: 1, seconds: 1);
      expect(getTimeText(d), "1 hour 1 minute 1 second");
    });

    test('Time text test with 1 second duration', () {
      Duration d = Duration(days: 1, hours:1, minutes: 1, seconds: 1);
      expect(getTimeText(d), "1 day 1 hour 1 minute 1 second");
    });
